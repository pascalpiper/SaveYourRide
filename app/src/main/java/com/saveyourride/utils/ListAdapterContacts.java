...
public class ListAdapterContacts extends ArrayAdapter {
    ...
    public ListAdapterContacts(Activity context, String[] names, String[] phoneNos) {
        super(context, R.layout.list_view_content_activity_main_settings, names);
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.list_view_content_activity_main_settings, null, true);
